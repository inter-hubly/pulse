...
ENV ENVIRONMENT_LINKER_HOST=${ENVIRONMENT_LINKER_HOST}
ENV ENVIRONMENT_KEEPER_HOST=${ENVIRONMENT_KEEPER_HOST}
ENV ENVIRONMENT_WEBHOOK_HOST=${ENVIRONMENT_WEBHOOK_HOST}
ENV ENVIRONMENT_PULSE_HOST=${ENVIRONMENT_PULSE_HOST}
ENV ENVIRONMENT_MONGO_DATABASE=${ENVIRONMENT_MONGO_DATABASE}
ENV ENVIRONMENT_MONGO_HOST=${ENVIRONMENT_MONGO_HOST}
